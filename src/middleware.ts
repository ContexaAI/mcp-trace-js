...
export class TraceMiddleware {
     ...
     */
    private captureResponseBody(res: Response): { body: any; contentType: string | undefined } {
        ...
        res.write = function (this: Response, chunk: any, encodingOrCallback?: any, callback?: any): boolean {
            if (chunk) {
    ...
    express() {
        return (req: Request, res: Response, next: NextFunction) => {
            const sessionId = (req.headers['mcp-session-id'] as string) || 'initialize-session';
            const clientId = (req.headers['mcp-client-id'] as string) || req.headers['user-agent'] || 'unknown';
